...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{BANANASTICKERS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{BANANASTICKERS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
bananastickers_server.pl - Catalyst Testserver

=head1 SYNOPSIS

bananastickers_server.pl [options]
